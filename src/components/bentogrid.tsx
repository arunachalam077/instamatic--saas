...
const logos = [
  "https://res.cloudinary.com/dtoul17rs/image/upload/v1727779603/gdxgsnobxhgdr0aordry.svg",
  "https://res.cloudinary.com/dtoul17rs/image/upload/v1727872266/yqumdv5lylrmakvmntg6.svg",
  "https://res.cloudinary.com/dtoul17rs/image/upload/v1727779604/nlvifqg268uxkfqh9rh6.svg"
];
  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative">
      ...
      <div className="text-left p-6 mt-4">
        <h1 className="text-white text-2xl font-bold mb-2">Instagram Automation with AI</h1>
        <p className="text-gray-400 text-lg">Our tool utilizes the latest in AI technology to automatically interact with your Instagram followers, delivering personalized messages and improving user satisfaction.</p>
      </div>
    </div>
  );
};
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full max-w-7xl min-h-[800px] md:min-h-[800px] md:h-[800px]">
        <CardWithEffect>
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="text-left p-6 mt-4">
              <h1 className="text-white text-2xl font-bold mb-2">AI-Driven Instagram Growth</h1>
              <p className="text-white/70 text-lg">Boost your Instagram engagement with automated, personalized messages powered by our AI. Increase follower interaction and save time with our smart automation tool</p>
            </div>
          </div>
        </CardWithEffect>
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                <h1 className="text-white text-2xl font-bold mb-2">Seamless Meta API Integration</h1>
                <p className="text-white/70 text-lg">Leverage the power of the official Meta API to automate messages on Instagram, ensuring compliance and reliability. Our AI messaging tool integrates smoothly, providing you with a competitive edge.</p>
              </div>
            </div>
          </CardWithEffect>
          <CardWithEffect>
